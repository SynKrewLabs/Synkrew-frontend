/**
 * SynKrew — Create Group: Success Confirmation
 * Route: app/(groups)/create/confirmation.tsx
 *
 * Implements:
 *   - Success handshake graphic & security badges
 *   - Mission parameter confirmation
 *   - "GO_TO_GROUP" CTA: Hands off data to the active Group Detail screen
 *   - "RETURN TO DASHBOARD" secondary link
 */
...
export default function CreateGroupConfirmationScreen() {
  ...
  const handleGoToGroup = () => {
    // Navigate to active Group Detail with newly created group parameters
    router.replace({
    ...
    <SafeAreaView style={styles.safe} edges={['top', 'bottom', 'left', 'right']}>
      ...
      >
        <View style={[styles.card, hardShadow(SHADOW_OFFSET), { width: cardWidth }]}>
          <TitleBar label="PACT_CONFIRMED.EXE" color="mint" />

          <View style={styles.body}>
            {/* Success Graphic Frame */}
            ...
            <View style={styles.textBlock}>
              <Text style={styles.headline}>PACT_INITIALIZED</Text>
              <Text style={styles.subtitle}>
                Your crew <Text style={{ fontWeight: '800', color: C.black }}>"{groupName.toUpperCase()}"</Text> has successfully assembled. The mission parameters are set, and the coordinates are locked in.
              </Text>
            </View>
            ...
            <View style={styles.badgesRow}>
              <View style={[styles.badgeItem, { backgroundColor: C.secondaryContainer }, hardShadow(1)]}>
                ...
                <Text style={styles.badgeLabel}>MEMBERS: {memberCount}/{memberCount}</Text>
              </View>
            ...
            <View style={[styles.summaryBox, hardShadow(SHADOW_OFFSET_SM)]}>
              <View style={styles.summaryItem}>
                ...
                <Text style={styles.summaryVal}>ACTIVE & TRACKING</Text>
              </View>
              <View style={styles.summaryItem}>
            ...
            <View style={styles.actionColumn}>
              ...
              >
                ...
                <Text style={styles.primaryBtnText}>GO_TO_GROUP</Text>
              </Pressable>
